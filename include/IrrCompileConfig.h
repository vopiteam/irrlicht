...
//! Identifies the IrrlichtKW fork customized for the Minetest engine
#define IRRLICHT_VERSION_KW_REVISION 1
#define IRRLICHT_VERSION_KW "kw1"
...
#define IRRLICHT_SDK_VERSION "1.9.0" IRRLICHT_VERSION_KW
